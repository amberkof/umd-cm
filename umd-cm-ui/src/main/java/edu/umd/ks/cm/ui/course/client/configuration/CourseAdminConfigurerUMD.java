...
public class CourseAdminConfigurerUMD extends CourseProposalConfigurerUMD {
    ...
    private CommentToolUMD createCommentTool(final MenuSectionController layout) {
    ...
    protected CollapsableSection generateCrossListed_Ver_Joint_Section() {
        CollapsableSection result = super.generateCrossListed_Ver_Joint_Section();
