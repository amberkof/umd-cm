...
public class FakeEnvResourceLoader {
    ...
    public void init() {
        ...
        ConfigurationService configurationService = new ConfigurationService() {
              public String getPropertyValueAsString(String key) { return "{0} message"; }
              public boolean getPropertyValueAsBoolean(String key) { return false; }
             public Map<String, String> getAllProperties() { return null; }
        };
